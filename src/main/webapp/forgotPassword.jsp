			...
			<div class="col-lg-8 col-md-10">
				...
				<form class="card mt-4" action="forgotPassword" method="POST">
					<div class="card-body">
						...
						<label for="usernmae-for-pass">Enter your user name</label> <input
								class="form-control" type="text" name="username" id="usernmae-for-pass" required="">
